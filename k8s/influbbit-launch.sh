...
# Download files
curl -s https://s3.amazonaws.com/influbbit/controller.yml > $INFLUBBIT_DIR/controller.yml
curl -s https://s3.amazonaws.com/influbbit/dockersecret.yml > $INFLUBBIT_DIR/dockersecret.yml
